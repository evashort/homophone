...
all =
  suite "Respell Suite"
    ...
    , test
        ...
        assertEqual
          (Just ("a b c de f g", 3 * grayCost + 3 * whiteCost)) <|
          respellExample
            [["x"]]
    ...
    , test
        ...
        assertEqual
          (Just ("ado go", grayCost + whiteCost)) <|
          respellExample
            [["a"], ["cat"], ["o"]]
            [("ado", 0.0), ("go", 0.0)]
            [("cat", [("dog", 0.0)])]
    ...
    , test
        ...
        assertEqual
          (Just ("bet dime", grayCost + whiteCost)) <|
          respellExample
            [["bed"], ["time"]]
            [("bet", 0.0), ("dime", 0.0)]
            [("dt", [("td", 0.0)])]
    ...
    , test
        ...
        assertEqual
          (Just ("la dox", grayCost + whiteCost)) <|
          respellExample
            [["le"], ["hot"], ["ax"]]
            [("dox", 0.0), ("la", 0.0)]
            [("ota", [("ado", 0.0)])]
    ...
    , test
        ...
        assertEqual
          (Just ("one pi", grayCost + whiteCost)) <|
          respellExample
            [["ox"], ["ate"], ["hi"]]
            [("one", 0.0), ("pi", 0.0)]
            [("xat", [("nep", 0.0)])]
