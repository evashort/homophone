    ...
    , test
        ...
        assertEqual
          ...
          respellExample
            ...
            []
    , test
        "unsplitCost n/a if next word starts with spaced 1val" <|
        assertEqual
          (Just ("balla tin ner", shallowCost + deepCost)) <|
          respellExample
            [["ballat"], ["dinner"]]
            ...
            []
    , test
        "unsplitCost n/a if next word starts with rabbit + spaced 1val" <|
        assertEqual
          (Just ("balla htin ner", shallowCost + deepCost)) <|
          respellExample
            [["ballat"], ["dinner"]]
    ...
    , test
        ...
        assertEqual
          ...
          respellExample
            ...
            []
    , test
        "unsplitCost n/a if final nval is from lspaced 1key" <|
        assertEqual
          (Just ("ballad din ner", shallowCost + deepCost)) <|
          respellExample
            [["balla"], ["dinner"]]
    ...
    , test
        ...
        assertEqual
          ...
          respellExample
            ...
            []
    , test
        "unsplitCost n/a if initial nval is from rspaced 1key" <|
        assertEqual
          (Just ("bal lad dinner", shallowCost + deepCost)) <|
          respellExample
            [["ballad"], ["inner"]]
    ...
    , test
        ...
        assertEqual
          ...
          respellExample
            ...
            []
    , test
        "unsplitCost n/a if final nval is from 1key with deletion after lspace" <|
        assertEqual
          (Just ("ballad din ner", shallowCost + deepCost)) <|
          respellExample
            [["balla"], ["hdinner"]]
    ...
    , test
        ...
        assertEqual
          ...
          respellExample
            ...
            [("h", 0.0)]
    , test
        "unsplitCost n/a if next word starts with spaced 1val followed by deletion" <|
        assertEqual
          (Just ("balla tin ner", shallowCost + deepCost)) <|
          respellExample
            [["ballat"], ["dhinner"]]
    ...
    , test
        ...
        assertEqual
          ...
          respellExample
            ...
            [("h", 0.0)]
    , test
        "unsplitCost n/a if word starts inside nval from 1key + space + deletion" <|
        assertEqual
          (Just ("bal lat tinner", shallowCost + deepCost)) <|
          respellExample
            [["ballat"], ["hinner"]]
            ...
            [("h", 0.0)]
    , test
        "unsplitCost n/a if word starts inside nval from 1key + deletion + space" <|
        assertEqual
          (Just ("bal lat tinner", shallowCost + deepCost)) <|
          respellExample
            [["ballath"], ["inner"]]
