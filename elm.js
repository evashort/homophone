...
Elm.Bisect = Elm.Bisect || {};
Elm.Bisect.make = function (_elm) {
   "use strict";
   _elm.Bisect = _elm.Bisect || {};
   if (_elm.Bisect.values) return _elm.Bisect.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var bisectRangeRight = F4(function (key,a,start,stop) {
      bisectRangeRight: while (true) if (_U.cmp(start,stop) > -1)
      return start; else {
            var mid = (start + stop) / 2 | 0;
            var tooHigh = function () {
               var _p0 = A2($Array.get,mid,a);
               if (_p0.ctor === "Nothing") {
                     return false;
                  } else {
                     return _U.cmp(_p0._0,key) > 0;
                  }
            }();
            if (tooHigh) {
                  var _v1 = key,_v2 = a,_v3 = start,_v4 = mid;
                  key = _v1;
                  a = _v2;
                  start = _v3;
                  stop = _v4;
                  continue bisectRangeRight;
               } else {
                  var _v5 = key,_v6 = a,_v7 = mid + 1,_v8 = stop;
                  key = _v5;
                  a = _v6;
                  start = _v7;
                  stop = _v8;
   ...
   var bisectRangeLeft = F4(function (key,a,start,stop) {
      bisectRangeLeft: while (true) if (_U.cmp(start,stop) > -1)
      return start; else {
            var mid = (start + stop) / 2 | 0;
            var tooLow = function () {
               var _p1 = A2($Array.get,mid,a);
               if (_p1.ctor === "Nothing") {
                     return false;
                  } else {
                     return _U.cmp(_p1._0,key) < 0;
                  }
            }();
            if (tooLow) {
                  var _v10 = key,_v11 = a,_v12 = mid + 1,_v13 = stop;
                  key = _v10;
                  a = _v11;
                  start = _v12;
                  stop = _v13;
                  continue bisectRangeLeft;
               } else {
                  var _v14 = key,_v15 = a,_v16 = start,_v17 = mid;
                  key = _v14;
                  a = _v15;
                  start = _v16;
                  stop = _v17;
   ...
   var bisectRight = F2(function (key,a) {
      return A4(bisectRangeRight,key,a,0,$Array.length(a));
   });
   var bisectLeft = F2(function (key,a) {
      return A4(bisectRangeLeft,key,a,0,$Array.length(a));
   });
   return _elm.Bisect.values = {_op: _op
                               ,bisectLeft: bisectLeft
                               ,bisectRight: bisectRight
                               ,bisectRangeLeft: bisectRangeLeft
                               ,bisectRangeRight: bisectRangeRight};
};
Elm.CBool = Elm.CBool || {};
Elm.CBool.make = function (_elm) {
   "use strict";
   _elm.CBool = _elm.CBool || {};
   if (_elm.CBool.values) return _elm.CBool.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var cTrue = 1;
   var cFalse = 0;
   var cBool = function (x) {    return x ? cTrue : cFalse;};
   return _elm.CBool.values = {_op: _op
                              ,cFalse: cFalse
                              ,cTrue: cTrue
                              ,cBool: cBool};
};
Elm.CompletionDict = Elm.CompletionDict || {};
Elm.CompletionDict.make = function (_elm) {
   "use strict";
   _elm.CompletionDict = _elm.CompletionDict || {};
   if (_elm.CompletionDict.values)
   return _elm.CompletionDict.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Bisect = Elm.Bisect.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var strictStartsWith = F2(function (sub,str) {
      return _U.cmp($String.length(sub),
      $String.length(str)) < 0 && A2($String.startsWith,sub,str);
   });
   var startWith = F2(function (key,d) {
      var i = A2($Bisect.bisectRight,key,d.keys);
      return A2($Maybe.withDefault,
      false,
      A2($Maybe.map,strictStartsWith(key),A2($Array.get,i,d.keys)));
   });
   var get = F2(function (key,d) {
      var i = A2($Bisect.bisectLeft,key,d.keys);
      var found = A2($Maybe.withDefault,
      false,
      A2($Maybe.map,
      F2(function (x,y) {    return _U.eq(x,y);})(key),
      A2($Array.get,i,d.keys)));
      return found ? A2($Array.get,i,d.values) : $Maybe.Nothing;
   });
   var fromSortedPairs = function (sortedPairs) {
      var keys = A2($List.map,$Basics.fst,sortedPairs);
      var sorted = function () {
         var _p0 = $List.tail(keys);
         if (_p0.ctor === "Nothing") {
               return true;
            } else {
               return A2($List.all,
               $Basics.identity,
               A3($List.map2,
               F2(function (x,y) {    return _U.cmp(x,y) < 0;}),
               keys,
               _p0._0));
            }
      }();
      return sorted ? $Maybe.Just({keys: $Array.fromList(keys)
                                  ,values: $Array.fromList(A2($List.map,
                                  $Basics.snd,
                                  sortedPairs))}) : $Maybe.Nothing;
   };
   var CompletionDict = F2(function (a,b) {
      return {keys: a,values: b};
   });
   return _elm.CompletionDict.values = {_op: _op
                                       ,CompletionDict: CompletionDict
                                       ,fromSortedPairs: fromSortedPairs
                                       ,get: get
                                       ,startWith: startWith
                                       ,strictStartsWith: strictStartsWith};
};
...
Elm.Parser.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var split3 = F2(function (sep,s) {
      var l0 = A2($String.split,sep,s);
      ...
      if (_p0.ctor === "_Tuple2" && _p0._0.ctor === "Just" && _p0._1.ctor === "Just")
      {
            ...
            if (_p1.ctor === "_Tuple2" && _p1._0.ctor === "Just" && _p1._1.ctor === "Just")
            {
                  ...
                  var _p2 = {ctor: "_Tuple2"
                            ,_0: $List.head(_p3)
                            ,_1: $List.tail(_p3)};
                  if (_p2.ctor === "_Tuple2" && _p2._0.ctor === "Just" && _p2._1.ctor === "Just" && _p2._1._0.ctor === "[]")
                  {
   ...
   var split2 = F2(function (sep,s) {
      ...
      if (_p5.ctor === "_Tuple2" && _p5._0.ctor === "Just" && _p5._1.ctor === "Just")
      {
            ...
            var _p6 = {ctor: "_Tuple2"
                      ,_0: $List.head(_p7)
                      ,_1: $List.tail(_p7)};
            if (_p6.ctor === "_Tuple2" && _p6._0.ctor === "Just" && _p6._1.ctor === "Just" && _p6._1._0.ctor === "[]")
            {
   ...
   var foldResults = function (results) {
      return A3($List.foldr,
      $Result.map2(F2(function (x,y) {
         return A2($List._op["::"],x,y);
      })),
      $Result.Ok(_U.list([])),
      results);
   };
   var nonEmptyLines = function (fileContents) {
      return A2($List.filter,
      function (_p8) {
         return $Basics.not($String.isEmpty(_p8));
      },
      $String.lines(fileContents));
   };
   return _elm.Parser.values = {_op: _op
                               ,nonEmptyLines: nonEmptyLines
                               ,foldResults: foldResults
                               ,split2: split2
                               ,split3: split3};
};
Elm.CostPair = Elm.CostPair || {};
Elm.CostPair.make = function (_elm) {
   "use strict";
   _elm.CostPair = _elm.CostPair || {};
   if (_elm.CostPair.values) return _elm.CostPair.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var costMultiplier = 1.0e-3;
   var parse = function (costPairString) {
      var _p0 = A2($Parser.split2,"=",costPairString);
      if (_p0.ctor === "Nothing") {
            return $Maybe.Nothing;
         } else {
            if (_p0._0._0 === "") {
                  ...
                  function (_p1) {
                     ...
                     _p0._0._0,
                     A2(F2(function (x,y) {    return x * y;}),costMultiplier,_p1));
                  },
                  $Result.toMaybe($String.toFloat(_p0._0._1)));
               }
         }
   };
   return _elm.CostPair.values = {_op: _op
                                 ,costMultiplier: costMultiplier
                                 ,parse: parse};
};
Elm.PairingHeap = Elm.PairingHeap || {};
Elm.PairingHeap.make = function (_elm) {
   "use strict";
   _elm.PairingHeap = _elm.PairingHeap || {};
   if (_elm.PairingHeap.values) return _elm.PairingHeap.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   var findMin = function (x) {
      ...
      if (_p0.ctor === "Empty") {
            ...
            return $Maybe.Just({ctor: "_Tuple2",_0: _p0._0,_1: _p0._1});
         }
   };
   var Heap = F3(function (a,b,c) {
      return {ctor: "Heap",_0: a,_1: b,_2: c};
   });
   var merge = F2(function (heap1,heap2) {
      ...
      if (_p1._0.ctor === "Empty") {
            ...
            if (_p1._1.ctor === "Empty") {
                  ...
                  var _p3 = _p1._1._0;
                  var _p2 = _p1._0._0;
                  return _U.cmp(_p2,_p3) < 0 ? A3(Heap,
                  _p2,
                  _p1._0._1,
                  A2($List._op["::"],heap2,_p1._0._2)) : A3(Heap,
                  _p3,
                  _p1._1._1,
                  A2($List._op["::"],heap1,_p1._1._2));
               }
         }
   });
   var insert = F2(function (_p4,heap) {
      var _p5 = _p4;
      return A2(merge,A3(Heap,_p5._0,_p5._1,_U.list([])),heap);
   });
   var Empty = {ctor: "Empty"};
   var empty = Empty;
   var fromList = A2($List.foldl,insert,empty);
   var mergePairs = function (heaps) {
      var _p6 = heaps;
      if (_p6.ctor === "[]") {
            return Empty;
         } else {
            if (_p6._1.ctor === "[]") {
                  ...
                  return A2(merge,
                  A2(merge,_p6._0,_p6._1._0),
                  mergePairs(_p6._1._1));
               }
         }
   };
   var deleteMin = function (heap) {
      var _p7 = heap;
      if (_p7.ctor === "Empty") {
            return Empty;
         } else {
            return mergePairs(_p7._2);
         }
   };
   var toSortedList = function (heap) {
      var _p8 = heap;
      if (_p8.ctor === "Empty") {
            return _U.list([]);
         } else {
            ...
            toSortedList(deleteMin(heap)));
         }
   };
   return _elm.PairingHeap.values = {_op: _op
                                    ,empty: empty
                                    ,findMin: findMin
                                    ,merge: merge
                                    ,insert: insert
...
Elm.DAG = Elm.DAG || {};
Elm.DAG.make = function (_elm) {
   "use strict";
   _elm.DAG = _elm.DAG || {};
   if (_elm.DAG.values) return _elm.DAG.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Bisect = Elm.Bisect.make(_elm),
   $CBool = Elm.CBool.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $PairingHeap = Elm.PairingHeap.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Set = Elm.Set.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var _op = {};
   var tieUpLooseEnd = F2(function (looseEnd,nodes) {
      var _p0 = A2($Array.get,looseEnd.src,nodes);
      if (_p0.ctor === "Nothing") {
            return nodes;
         } else {
            return A3($Array.set,
            looseEnd.src,
            A2($List._op["::"],
            {phoneme: looseEnd.phoneme,dst: $Array.length(nodes)},
            _p0._0),
            nodes);
         }
   });
   var pathListKey = function (pathList) {
      return $Basics.negate(A2($Maybe.withDefault,
      0,
      $List.maximum(A2($List.map,$String.length,pathList))));
   };
   var insertLooseEnd = F4(function (i,_p1,pathSet,fringe) {
      var _p2 = _p1;
      var pathList = $Set.toList(pathSet);
      return A2($PairingHeap.insert,
      {ctor: "_Tuple2"
      ,_0: {ctor: "_Tuple2",_0: pathListKey(pathList),_1: pathList}
      ,_1: {src: i,phoneme: _p2._0}},
      fringe);
   });
   var insertPath = F2(function (pathString,pathSets) {
      var _p3 = $String.uncons(pathString);
      if (_p3.ctor === "Nothing") {
            return pathSets;
         } else {
            var _p4 = _p3._0._1;
            var key = {ctor: "_Tuple2"
                      ,_0: _p3._0._0
                      ,_1: $CBool.cBool(_U.eq(_p4,""))};
            var pathSet = A2($Maybe.withDefault,
            $Set.empty,
            A2($Dict.get,key,pathSets));
            return A3($Dict.insert,
            key,
            A2($Set.insert,_p4,pathSet),
            pathSets);
         }
   });
   var getLooseEndsHelper = F3(function (looseEnds,
   pathList,
   fringe) {
      getLooseEndsHelper: while (true) {
         var _p5 = $PairingHeap.findMin(fringe);
         if (_p5.ctor === "Nothing") {
               return {ctor: "_Tuple3"
                      ,_0: pathList
                      ,_1: looseEnds
               ...
               if (_U.eq(_p5._0._0._1,pathList)) {
                     var _v4 = A2($List._op["::"],_p5._0._1,looseEnds),
                     _v5 = pathList,
                     _v6 = $PairingHeap.deleteMin(fringe);
                     looseEnds = _v4;
                     pathList = _v5;
                     fringe = _v6;
                     continue getLooseEndsHelper;
                  } else return {ctor: "_Tuple3"
                                ,_0: pathList
                                ,_1: looseEnds
                                ,_2: fringe};
            }
   ...
   var getLooseEnds = function (fringe) {
      var _p6 = $PairingHeap.findMin(fringe);
      if (_p6.ctor === "Nothing") {
            return $Maybe.Nothing;
         } else {
            return $Maybe.Just(A3(getLooseEndsHelper,
            _U.list([]),
            _p6._0._0._1,
            fringe));
         }
   };
   var appendPathListHelper = F2(function (fringe,nodes) {
      appendPathListHelper: while (true) {
         var _p7 = getLooseEnds(fringe);
         if (_p7.ctor === "Nothing") {
               return nodes;
            } else {
               var pathSets = A3($List.foldl,
               insertPath,
               $Dict.empty,
               _p7._0._0);
               var nodes2 = A3($List.foldl,tieUpLooseEnd,nodes,_p7._0._1);
               var nodes3 = A2($Array.push,_U.list([]),nodes2);
               var fringe3 = A3($Dict.foldl,
               insertLooseEnd($Array.length(nodes2)),
               _p7._0._2,
               pathSets);
               var _v9 = fringe3,_v10 = nodes3;
               fringe = _v9;
               nodes = _v10;
               continue appendPathListHelper;
            }
      }
   });
   var appendPathList = F2(function (pathList,dag) {
      var pathSets = A3($List.foldl,
      insertPath,
      $Dict.empty,
      pathList);
      var fringe = A3($Dict.foldl,
      insertLooseEnd($Array.length(dag.nodes) - 1),
      $PairingHeap.empty,
      pathSets);
      var newNodes = A2(appendPathListHelper,fringe,dag.nodes);
      return {nodes: newNodes
             ,spaces: A2($Array.push,
             $Array.length(newNodes) - 1,
             dag.spaces)};
   });
   var fromPathLists = function (pathLists) {
      return A3($List.foldl,
      appendPathList,
      {nodes: $Array.fromList(_U.list([_U.list([])]))
      ,spaces: $Array.fromList(_U.list([0]))},
      pathLists);
   };
   var spaceInRange = F3(function (start,end,dag) {
      return _U.cmp(A2($Bisect.bisectLeft,start,dag.spaces),
      A2($Bisect.bisectRight,end,dag.spaces)) < 0;
   });
   var isSpace = F2(function (i,dag) {
      return A2($Maybe.withDefault,
      false,
      A2($Maybe.map,
      F2(function (x,y) {    return _U.eq(x,y);})(i),
      A2($Array.get,A2($Bisect.bisectLeft,i,dag.spaces),dag.spaces)));
   });
   var length = function (_p8) {
      return $Array.length(function (_) {
         return _.nodes;
      }(_p8));
   };
   var get = F2(function (i,dag) {
      return A2($Maybe.withDefault,
      _U.list([]),
      A2($Array.get,i,dag.nodes));
   });
   var LooseEnd = F2(function (a,b) {
      return {src: a,phoneme: b};
   });
   var Edge = F2(function (a,b) {    return {phoneme: a,dst: b};});
   var DAG = F2(function (a,b) {    return {nodes: a,spaces: b};});
   return _elm.DAG.values = {_op: _op
                            ,DAG: DAG
                            ,Edge: Edge
                            ,LooseEnd: LooseEnd
                            ,get: get
                            ,length: length
                            ,isSpace: isSpace
                            ,spaceInRange: spaceInRange
                            ,fromPathLists: fromPathLists
                            ,appendPathList: appendPathList
                            ,appendPathListHelper: appendPathListHelper
                            ,getLooseEnds: getLooseEnds
                            ,getLooseEndsHelper: getLooseEndsHelper
                            ,insertPath: insertPath
                            ,insertLooseEnd: insertLooseEnd
                            ,pathListKey: pathListKey
                            ,tieUpLooseEnd: tieUpLooseEnd};
};
Elm.DeletionCosts = Elm.DeletionCosts || {};
Elm.DeletionCosts.make = function (_elm) {
   "use strict";
   _elm.DeletionCosts = _elm.DeletionCosts || {};
   if (_elm.DeletionCosts.values) return _elm.DeletionCosts.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $CompletionDict = Elm.CompletionDict.make(_elm),
   $CostPair = Elm.CostPair.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Parser = Elm.Parser.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var parseErrorToString = function (err) {
      var _p0 = err;
      if (_p0.ctor === "InvalidCostPair") {
            return A2($Basics._op["++"],
            "\"",
            A2($Basics._op["++"],
            _p0._0,
            "\" is not of the form \"key=cost\""));
         } else {
            return "keys are not in sorted order";
         }
   };
   var NotSorted = {ctor: "NotSorted"};
   var InvalidCostPair = function (a) {
      return {ctor: "InvalidCostPair",_0: a};
   };
   var parseDeletionCost = function (costPairString) {
      return A2($Result.fromMaybe,
      InvalidCostPair(costPairString),
      $CostPair.parse(costPairString));
   };
   var parseSortedPairs = function (fileContents) {
      return $Parser.foldResults(A2($List.map,
      parseDeletionCost,
      $Parser.nonEmptyLines(fileContents)));
   };
   var parse = function (fileContents) {
      ...
      function (_p1) {
         return A2($Result.fromMaybe,
         NotSorted,
         $CompletionDict.fromSortedPairs(_p1));
      });
   };
   return _elm.DeletionCosts.values = {_op: _op
                                      ,InvalidCostPair: InvalidCostPair
                                      ,NotSorted: NotSorted
                                      ,parseErrorToString: parseErrorToString
                                      ,parse: parse
                                      ,parseSortedPairs: parseSortedPairs
                                      ,parseDeletionCost: parseDeletionCost};
};
Elm.PrioritySet = Elm.PrioritySet || {};
Elm.PrioritySet.make = function (_elm) {
   "use strict";
   _elm.PrioritySet = _elm.PrioritySet || {};
   if (_elm.PrioritySet.values) return _elm.PrioritySet.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var parify = function (x) {
      return {ctor: "_Tuple2",_0: x,_1: {ctor: "_Tuple0"}};
   };
   var fromList = function (xs) {
      var set = $Set.fromList(xs);
      return {heap: $PairingHeap.fromList(A2($List.map,
             parify,
             $Set.toList(set)))
             ,set: set};
   };
   var deleteMin = function (s) {
      var _p0 = $PairingHeap.findMin(s.heap);
      if (_p0.ctor === "Nothing") {
            return s;
         } else {
            return {heap: $PairingHeap.deleteMin(s.heap)
                   ,set: A2($Set.remove,_p0._0._0,s.set)};
         }
   };
   var findMin = function (s) {
      return A2($Maybe.map,
      $Basics.fst,
      $PairingHeap.findMin(s.heap));
   };
   var insert = F2(function (k,s) {
      return A2($Set.member,
      k,
      s.set) ? s : {heap: A2($PairingHeap.insert,
                   {ctor: "_Tuple2",_0: k,_1: {ctor: "_Tuple0"}},
                   s.heap)
                   ,set: A2($Set.insert,k,s.set)};
   });
   var empty = {heap: $PairingHeap.empty,set: $Set.empty};
   var PrioritySet = F2(function (a,b) {
      return {heap: a,set: b};
   });
   return _elm.PrioritySet.values = {_op: _op
...
Elm.Knapsack = Elm.Knapsack || {};
Elm.Knapsack.make = function (_elm) {
   "use strict";
   _elm.Knapsack = _elm.Knapsack || {};
   if (_elm.Knapsack.values) return _elm.Knapsack.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $PrioritySet = Elm.PrioritySet.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var insertState = F3(function (keyFunc,pricedState,_p0) {
      var _p1 = _p0;
      var _p4 = _p1._0;
      var _p3 = _p1._1;
      var key = keyFunc(pricedState.state);
      var shouldInsert = A2($Maybe.withDefault,
      true,
      A2($Maybe.map,
      function (_p2) {
      ...
      A2($Dict.get,key,_p4)));
      return shouldInsert ? {ctor: "_Tuple2"
                            ,_0: A3($Dict.insert,key,pricedState,_p4)
                            ,_1: A2($PrioritySet.insert,key,_p3)} : {ctor: "_Tuple2"
                                                                    ,_0: _p4
                                                                    ,_1: _p3};
   });
   var increaseCostBy = F2(function (increase,pricedState) {
      return _U.update(pricedState,
      {cost: pricedState.cost + increase});
   });
   var knapsackHelper = F4(function (keyFunc,
   successorFunc,
   states,
   fringe) {
      knapsackHelper: while (true) {
         var _p5 = $PrioritySet.findMin(fringe);
         if (_p5.ctor === "Nothing") {
               return states;
            } else {
               var _p6 = A2($Dict.get,_p5._0,states);
               if (_p6.ctor === "Nothing") {
                     return $Dict.empty;
                  } else {
                     var _p8 = _p6._0;
                     var successors = A2($List.map,
                     increaseCostBy(_p8.cost),
                     successorFunc(_p8.state));
                     var _p7 = A3($List.foldl,
                     insertState(keyFunc),
                     {ctor: "_Tuple2",_0: states,_1: $PrioritySet.deleteMin(fringe)},
                     successors);
                     var newStates = _p7._0;
                     var newFringe = _p7._1;
                     var _v3 = keyFunc,
                     _v4 = successorFunc,
                     _v5 = newStates,
                     _v6 = newFringe;
                     ...
                     states = _v5;
                     fringe = _v6;
                     continue knapsackHelper;
                  }
            }
      }
   });
   var getKnapsacks = F3(function (keyFunc,successorFunc,seed) {
      var keys = A2($List.map,
      function (_p9) {
         return keyFunc(function (_) {    return _.state;}(_p9));
      },
      seed);
      var fringe = $PrioritySet.fromList(keys);
      var states = $Dict.fromList(A3($List.map2,
      F2(function (v0,v1) {
         return {ctor: "_Tuple2",_0: v0,_1: v1};
      }),
      keys,
      seed));
      return A4(knapsackHelper,keyFunc,successorFunc,states,fringe);
   });
   var Priced = F2(function (a,b) {
      return {state: a,cost: b};
   });
   return _elm.Knapsack.values = {_op: _op
                                 ,Priced: Priced
                                 ,getKnapsacks: getKnapsacks
                                 ,knapsackHelper: knapsackHelper
                                 ,increaseCostBy: increaseCostBy
                                 ,insertState: insertState};
};
Elm.Deletions = Elm.Deletions || {};
Elm.Deletions.make = function (_elm) {
   "use strict";
   _elm.Deletions = _elm.Deletions || {};
   if (_elm.Deletions.values) return _elm.Deletions.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $CompletionDict = Elm.CompletionDict.make(_elm),
   $DAG = Elm.DAG.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $DeletionCosts = Elm.DeletionCosts.make(_elm),
   $Dict = Elm.Dict.make(_elm),
   $Knapsack = Elm.Knapsack.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var _op = {};
   var deletionChoicesHelper = F4(function (deletionCosts,
   dag,
   key,
   edge) {
      var newKey = A2($Basics._op["++"],
      key,
      $String.fromChar(edge.phoneme));
      var rest = A2($CompletionDict.startWith,
      newKey,
      deletionCosts) ? A2($List.concatMap,
      A3(deletionChoicesHelper,deletionCosts,dag,newKey),
      A2($DAG.get,edge.dst,dag)) : _U.list([]);
      var _p0 = A2($CompletionDict.get,newKey,deletionCosts);
      if (_p0.ctor === "Nothing") {
            return rest;
         } else {
            return A2($List._op["::"],
            {state: edge.dst,cost: _p0._0},
            rest);
         }
   });
   var deletionChoices = F3(function (deletionCosts,dag,i) {
      return A2($List.concatMap,
      A3(deletionChoicesHelper,deletionCosts,dag,""),
      A2($DAG.get,i,dag));
   });
   var toHiker = F3(function (dag,start,deletion) {
      return _U.update(deletion,
      {state: {i: deletion.state
              ,inSpace: A3($DAG.spaceInRange,start,deletion.state,dag)}});
   });
   var getDeletions = F3(function (deletionCosts,dag,i) {
      return A2($List.map,
      A2(toHiker,dag,i),
      $Dict.values(A3($Knapsack.getKnapsacks,
      $Basics.identity,
      A2(deletionChoices,deletionCosts,dag),
      _U.list([{state: i,cost: 0.0}]))));
   });
   var Hiker = F2(function (a,b) {    return {i: a,inSpace: b};});
   return _elm.Deletions.values = {_op: _op
                                  ,Hiker: Hiker
                                  ,getDeletions: getDeletions
                                  ,toHiker: toHiker
                                  ,deletionChoices: deletionChoices
                                  ,deletionChoicesHelper: deletionChoicesHelper};
};
Elm.PricedValue = Elm.PricedValue || {};
Elm.PricedValue.make = function (_elm) {
   "use strict";
   _elm.PricedValue = _elm.PricedValue || {};
   if (_elm.PricedValue.values) return _elm.PricedValue.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var toValueSplit = F3(function (used,leftovers,cost) {
      return {used: used,leftovers: leftovers,cost: cost};
   });
   var getValueSplits = function (pricedValue) {
      var _p0 = {ctor: "_Tuple2"
                ,_0: $List.head(pricedValue)
                ,_1: $List.tail(pricedValue)};
      if (_p0.ctor === "_Tuple2" && _p0._0.ctor === "Just" && _p0._1.ctor === "Just")
      {
            var _p2 = _p0._1._0;
            return A4($List.map3,
            ...
            A2($List.map,
            function (_p1) {
               return $String.fromList(F2(function (x,y) {
                  return A2($List._op["::"],x,y);
               })($Basics.fst(_p0._0._0))($List.reverse(_p1)));
            },
            A3($List.scanl,
            F2(function (x,y) {    return A2($List._op["::"],x,y);}),
            _U.list([]),
            A2($List.map,$Basics.fst,_p2))),
            $List.reverse(A3($List.scanl,
            F2(function (x,y) {    return A2($List._op["::"],x,y);}),
            _U.list([]),
            $List.reverse(_p2))),
            A2($List.map,$Basics.snd,pricedValue));
         } else {
            return _U.list([]);
         }
   };
   var getValue = function (pricedValue) {
      return $String.fromList(A2($List.map,
      $Basics.fst,
      pricedValue));
   };
   var empty = _U.list([]);
   var ValueSplit = F3(function (a,b,c) {
      return {used: a,leftovers: b,cost: c};
   });
   var whiteCost = 2.0;
   var grayCost = 1.0;
   var blackCost = 0.0;
   var indexCost = F2(function (costTiers,index) {
      indexCost: while (true) {
         var _p3 = {ctor: "_Tuple2"
                   ,_0: $List.head(costTiers)
                   ,_1: $List.tail(costTiers)};
         if (_p3.ctor === "_Tuple2" && _p3._0.ctor === "Just" && _p3._0._0.ctor === "_Tuple2" && _p3._1.ctor === "Just")
         {
               if (_U.cmp(index,_p3._0._0._0) > -1) return _p3._0._0._1;
               else {
                     var _v2 = _p3._1._0,_v3 = index;
                     costTiers = _v2;
                     index = _v3;
                     continue indexCost;
                  }
   ...
   var pricePhoneme = F3(function (costTiers,index,phoneme) {
      return {ctor: "_Tuple2"
             ,_0: phoneme
             ,_1: A2(indexCost,costTiers,index)};
   });
   var price = F3(function (key,spaces,value) {
      var valueLength = $String.length(value);
      var keyLength = $String.length(key);
      var costTiers = function () {
         var _p4 = {ctor: "_Tuple2"
                   ,_0: $List.head(spaces)
                   ,_1: $List.head($List.reverse(spaces))};
         if (_p4.ctor === "_Tuple2" && _p4._0.ctor === "Just" && _p4._1.ctor === "Just")
         {
               return _U.list([{ctor: "_Tuple2"
                               ,_0: _p4._1._0 + valueLength - keyLength
                               ,_1: blackCost}
                              ,{ctor: "_Tuple2",_0: valueLength - 1,_1: whiteCost}
                              ,{ctor: "_Tuple2",_0: _p4._0._0 - 1,_1: grayCost}]);
            } else {
               return _U.list([]);
            }
      }();
      return A2($List.indexedMap,
      pricePhoneme(costTiers),
      $String.toList(value));
   });
   return _elm.PricedValue.values = {_op: _op
                                    ,blackCost: blackCost
                                    ,grayCost: grayCost
                                    ,whiteCost: whiteCost
                                    ,ValueSplit: ValueSplit
                                    ,price: price
                                    ,pricePhoneme: pricePhoneme
                                    ,indexCost: indexCost
                                    ,empty: empty
                                    ,getValue: getValue
                                    ,getValueSplits: getValueSplits
                                    ,toValueSplit: toValueSplit};
};
Elm.SubCosts = Elm.SubCosts || {};
Elm.SubCosts.make = function (_elm) {
   "use strict";
   _elm.SubCosts = _elm.SubCosts || {};
   if (_elm.SubCosts.values) return _elm.SubCosts.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $CompletionDict = Elm.CompletionDict.make(_elm),
   $CostPair = Elm.CostPair.make(_elm),
   ...
   var parseErrorToString = function (err) {
      var _p0 = err;
      switch (_p0.ctor)
      {case "InvalidCostPair": return A2($Basics._op["++"],
           "\"",
           A2($Basics._op["++"],
           _p0._0,
           "\" is not of the form \"value=cost\""));
         case "NoValues": return A2($Basics._op["++"],
           "no values for key \"",
           A2($Basics._op["++"],_p0._0,"\""));
         case "KeyEqualsValue": return A2($Basics._op["++"],
           "key \"",
           A2($Basics._op["++"],_p0._0,"\" has identical value"));
         default: return "keys are not in sorted order";}
   };
   var NotSorted = {ctor: "NotSorted"};
   var KeyEqualsValue = function (a) {
      return {ctor: "KeyEqualsValue",_0: a};
   };
   var addKey = F2(function (key,costPairs) {
      return A2($List.member,
      key,
      A2($List.map,
      $Basics.fst,
      costPairs)) ? $Result.Err(KeyEqualsValue(key)) : $Result.Ok({ctor: "_Tuple2"
                                                                  ,_0: key
                                                                  ,_1: costPairs});
   });
   var NoValues = function (a) {
      return {ctor: "NoValues",_0: a};
   };
   var InvalidCostPair = function (a) {
      return {ctor: "InvalidCostPair",_0: a};
   };
   var parseSubCost = function (costPairString) {
      return A2($Result.fromMaybe,
      InvalidCostPair(costPairString),
      $CostPair.parse(costPairString));
   };
   var parseCostPairs = function (menu) {
      return $Parser.foldResults(A2($List.map,parseSubCost,menu));
   };
   var parseMenu = function (menuString) {
      var tokens = A2($String.split," ",menuString);
      var _p1 = {ctor: "_Tuple2"
                ,_0: $List.head(tokens)
                ,_1: $List.tail(tokens)};
      if (_p1.ctor === "_Tuple2" && _p1._0.ctor === "Just" && _p1._1.ctor === "Just")
      {
            if (_p1._1._0.ctor === "[]") {
                  return $Result.Err(NoValues(_p1._0._0));
               } else {
                  return A2($Result.andThen,
                  parseCostPairs(_p1._1._0),
                  addKey(_p1._0._0));
               }
         } else {
            return $Result.Err(NoValues("this should never happen"));
         }
   };
   var parseSortedMenus = function (fileContents) {
      return $Parser.foldResults(A2($List.map,
      parseMenu,
      $Parser.nonEmptyLines(fileContents)));
   };
   var parse = function (fileContents) {
      ...
      function (_p2) {
         return A2($Result.fromMaybe,
         NotSorted,
         $CompletionDict.fromSortedPairs(_p2));
      });
   };
   return _elm.SubCosts.values = {_op: _op
                                 ,InvalidCostPair: InvalidCostPair
                                 ,NoValues: NoValues
                                 ...
                                 ,parseErrorToString: parseErrorToString
                                 ,parse: parse
                                 ,parseSortedMenus: parseSortedMenus
                                 ,parseMenu: parseMenu
                                 ,parseCostPairs: parseCostPairs
                                 ,parseSubCost: parseSubCost
                                 ,addKey: addKey};
};
Elm.Subs = Elm.Subs || {};
Elm.Subs.make = function (_elm) {
   "use strict";
   _elm.Subs = _elm.Subs || {};
   if (_elm.Subs.values) return _elm.Subs.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $CompletionDict = Elm.CompletionDict.make(_elm),
   $CostPair = Elm.CostPair.make(_elm),
   ...
   $Debug = Elm.Debug.make(_elm),
   $DeletionCosts = Elm.DeletionCosts.make(_elm),
   $Deletions = Elm.Deletions.make(_elm),
   $Knapsack = Elm.Knapsack.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $PricedValue = Elm.PricedValue.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm),
   $SubCosts = Elm.SubCosts.make(_elm);
   var _op = {};
   var toSubChoice = F4(function (key,
   spaces,
   pricedValue,
   deletion) {
      var deletionsAddedSpace = deletion.state.inSpace && A2($Maybe.withDefault,
      true,
      A2($Maybe.map,
      F2(function (x,y) {
         return _U.cmp(x,y) > 0;
      ...
      $List.head(spaces)));
      var newSpaces = deletionsAddedSpace ? A2($List._op["::"],
      $String.length(key),
      spaces) : spaces;
      return {value: A3($PricedValue.price,
             key,
             $List.reverse(newSpaces),
             $Basics.fst(pricedValue))
             ,cost: $Basics.snd(pricedValue) + deletion.cost
             ,rest: deletion.state};
   });
   var toSubChoices = F4(function (key,spaces,deletions,value) {
      return A2($List.map,
      A3(toSubChoice,key,spaces,value),
      deletions);
   });
   var getValueChoices = F2(function (key,subCosts) {
      return _U.eq($String.length(key),
      1) ? $Maybe.Just(A2($List._op["::"],
      {ctor: "_Tuple2",_0: key,_1: 0.0},
      A2($Maybe.withDefault,
      _U.list([]),
      A2($CompletionDict.get,
      key,
      subCosts)))) : A2($CompletionDict.get,key,subCosts);
   });
   var subChoicesHelper = F6(function (deletionCosts,
   subCosts,
   dag,
   key,
   spaces,
   edge) {
      ...
      key,
      $String.fromChar(edge.phoneme));
      var newSpaces = A2($DAG.isSpace,
      edge.dst,
      dag) ? A2($List._op["::"],
      $String.length(newKey),
      spaces) : spaces;
      var rest = A2($CompletionDict.startWith,
      newKey,
      subCosts) ? A2($List.concatMap,
      A5(subChoicesHelper,
      deletionCosts,
      subCosts,
      dag,
      ...
      newSpaces),
      A2($DAG.get,edge.dst,dag)) : _U.list([]);
      var _p0 = A2(getValueChoices,newKey,subCosts);
      if (_p0.ctor === "Nothing") {
            return rest;
         } else {
            var deletions = A3($Deletions.getDeletions,
            deletionCosts,
            dag,
            edge.dst);
            return A2($Basics._op["++"],
            A2($List.concatMap,
            A3(toSubChoices,newKey,newSpaces,deletions),
            _p0._0),
            rest);
         }
   });
   var getSubChoices = F4(function (deletionCosts,
   subCosts,
   dag,
   hiker) {
      var spaces = hiker.inSpace ? _U.list([0]) : _U.list([]);
      var subs = A2($List.concatMap,
      A5(subChoicesHelper,deletionCosts,subCosts,dag,"",spaces),
      A2($DAG.get,hiker.i,dag));
      var rabbits = A2($List.concatMap,
      A3(toSubChoices,"",spaces,_U.list([{state: hiker,cost: 0.0}])),
      A2($Maybe.withDefault,
      _U.list([]),
      A2($CompletionDict.get,"",subCosts)));
      return A2($Basics._op["++"],rabbits,subs);
   });
   var SubChoice = F3(function (a,b,c) {
      return {value: a,cost: b,rest: c};
   });
   return _elm.Subs.values = {_op: _op
                             ,SubChoice: SubChoice
                             ,getSubChoices: getSubChoices
                             ,subChoicesHelper: subChoicesHelper
                             ,getValueChoices: getValueChoices
                             ,toSubChoices: toSubChoices
                             ,toSubChoice: toSubChoice};
};
Elm.WordCosts = Elm.WordCosts || {};
Elm.WordCosts.make = function (_elm) {
   "use strict";
   _elm.WordCosts = _elm.WordCosts || {};
   if (_elm.WordCosts.values) return _elm.WordCosts.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $CompletionDict = Elm.CompletionDict.make(_elm),
   $CostPair = Elm.CostPair.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var collapseByWord = F2(function (wordCostPair,wordCostPairs) {
      var _p0 = {ctor: "_Tuple2"
                ,_0: $List.head(wordCostPairs)
                ,_1: $List.tail(wordCostPairs)};
      if (_p0.ctor === "_Tuple2" && _p0._0.ctor === "Just" && _p0._0._0.ctor === "_Tuple2" && _p0._0._0._1.ctor === "_Tuple2" && _p0._1.ctor === "Just")
      {
            return _U.eq(_p0._0._0._0,
            $Basics.fst(wordCostPair)) ? A2($List._op["::"],
            wordCostPair,
            _p0._1._0) : A2($List._op["::"],wordCostPair,wordCostPairs);
         } else {
            return A2($List._op["::"],wordCostPair,wordCostPairs);
         }
   });
   var wordCostPairKey = function (_p1) {
      var _p2 = _p1;
      return {ctor: "_Tuple2",_0: _p2._0,_1: _p2._1._1};
   };
   var toWordCostPair = function (_p3) {
      var _p4 = _p3;
      return {ctor: "_Tuple2"
             ,_0: _p4._2
             ,_1: {ctor: "_Tuple2",_0: _p4._0,_1: _p4._1}};
   };
   var toWordCostPairs = function (triplets) {
      return A3($List.foldr,
      collapseByWord,
      _U.list([]),
      A2($List.sortBy,
      wordCostPairKey,
      A2($List.map,toWordCostPair,triplets)));
   };
   var collapseBySpelling = F2(function (_p5,pronouncerPairs) {
      var _p6 = _p5;
      var _p10 = _p6._1;
      var _p9 = _p6._0;
      var _p7 = {ctor: "_Tuple2"
                ,_0: $List.head(pronouncerPairs)
                ,_1: $List.tail(pronouncerPairs)};
      if (_p7.ctor === "_Tuple2" && _p7._0.ctor === "Just" && _p7._0._0.ctor === "_Tuple2" && _p7._1.ctor === "Just")
      {
            var _p8 = _p7._0._0._0;
            return _U.eq(_p8,_p9) ? A2($List._op["::"],
            {ctor: "_Tuple2"
            ,_0: _p8
            ,_1: A2($List._op["::"],_p10,_p7._0._0._1)},
            _p7._1._0) : A2($List._op["::"],
            {ctor: "_Tuple2",_0: _p9,_1: _U.list([_p10])},
            pronouncerPairs);
         } else {
            return A2($List._op["::"],
            {ctor: "_Tuple2",_0: _p9,_1: _U.list([_p10])},
   ...
   var toSpellingPair = function (_p11) {
      var _p12 = _p11;
      return {ctor: "_Tuple2"
             ,_0: $String.toLower(_p12._0)
             ,_1: _p12._2};
   };
   var toPronouncerPairs = function (triplets) {
      return A3($List.foldr,
      collapseBySpelling,
      _U.list([]),
      A2($List.map,toSpellingPair,triplets));
   };
   var sandwich = F3(function (x,z,y) {
      return {ctor: "_Tuple3",_0: x,_1: y,_2: z};
   });
   var parseErrorToString = function (err) {
      var _p13 = err;
      if (_p13.ctor === "InvalidTriplet") {
            return A2($Basics._op["++"],
            "\"",
            A2($Basics._op["++"],
            _p13._0,
            "\" is not of the form \"spelling\tcost\tphonemes\""));
         } else {
            return "spellings are not in sorted order";
         }
   };
   var NotSorted = {ctor: "NotSorted"};
   var InvalidTriplet = function (a) {
      return {ctor: "InvalidTriplet",_0: a};
   };
   var costMultiplier = 3.0 / 25784.0;
   var parseTriplet = function (tripletString) {
      return A2($Result.fromMaybe,
      InvalidTriplet(tripletString),
      function () {
         var _p14 = A2($Parser.split3,"\t",tripletString);
               ...
               if (_p14._0._0 === "") {
                     ...
                     if (_p14._0._2 === "") {
                           ...
                           function (_p15) {
                              ...
                              _p14._0._0,
                              _p14._0._2,
                              A2(F2(function (x,y) {    return x * y;}),costMultiplier,_p15));
                           },
                           $Result.toMaybe($String.toFloat(_p14._0._1)));
                        }
                  }
            }
      }());
   };
   var parseTriplets = function (fileContents) {
      return $Parser.foldResults(A2($List.map,
      parseTriplet,
      $Parser.nonEmptyLines(fileContents)));
   };
   var parse = function (fileContents) {
      var triplets = parseTriplets(fileContents);
      return A3($Result.map2,
      F2(function (v0,v1) {
         return {ctor: "_Tuple2",_0: v0,_1: v1};
      }),
      A2($Result.andThen,
      A2($Result.map,toPronouncerPairs,triplets),
      function (_p16) {
         return A2($Result.fromMaybe,
         NotSorted,
         $CompletionDict.fromSortedPairs(_p16));
      }),
      A2($Result.andThen,
      A2($Result.map,toWordCostPairs,triplets),
      function (_p17) {
         return A2($Result.fromMaybe,
         NotSorted,
         $CompletionDict.fromSortedPairs(_p17));
      }));
   };
   return _elm.WordCosts.values = {_op: _op
                                  ,costMultiplier: costMultiplier
                                  ,InvalidTriplet: InvalidTriplet
                                  ,NotSorted: NotSorted
                                  ,parseErrorToString: parseErrorToString
                                  ,parse: parse
                                  ,parseTriplets: parseTriplets
                                  ,parseTriplet: parseTriplet
                                  ,sandwich: sandwich
                                  ,toPronouncerPairs: toPronouncerPairs
                                  ,toSpellingPair: toSpellingPair
                                  ,collapseBySpelling: collapseBySpelling
                                  ,toWordCostPairs: toWordCostPairs
                                  ,toWordCostPair: toWordCostPair
                                  ,wordCostPairKey: wordCostPairKey
                                  ,collapseByWord: collapseByWord};
};
Elm.Repronounce = Elm.Repronounce || {};
Elm.Repronounce.make = function (_elm) {
   "use strict";
   _elm.Repronounce = _elm.Repronounce || {};
   if (_elm.Repronounce.values) return _elm.Repronounce.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $CBool = Elm.CBool.make(_elm),
   $CompletionDict = Elm.CompletionDict.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm),
   $SubCosts = Elm.SubCosts.make(_elm),
   $Subs = Elm.Subs.make(_elm),
   $WordCosts = Elm.WordCosts.make(_elm);
   var _op = {};
   var toWordChoice = F6(function (wordCosts,
   spellings,
   word,
   cost,
   rest,
   split) {
      var _p0 = A2($CompletionDict.get,
      A2($Basics._op["++"],word,split.used),
      wordCosts);
      if (_p0.ctor === "Nothing") {
            return $Maybe.Nothing;
         } else {
            return $Maybe.Just({state: {spellings: A2($List._op["::"],
                                       _p0._0._0,
                                       spellings)
                                       ,rest: rest
                                       ,leftovers: split.leftovers}
                               ,cost: cost + split.cost + _p0._0._1});
         }
   });
   var getWordChoices = F6(function (data,
   dag,
   spellings,
   word,
   cost,
   subChoice) {
      var newCost = cost + subChoice.cost;
      var newWord = A2($Basics._op["++"],
      word,
      $PricedValue.getValue(subChoice.value));
      var rest = A2($CompletionDict.startWith,
      newWord,
      data.wordCosts) ? A2($List.concatMap,
      A5(getWordChoices,data,dag,spellings,newWord,newCost),
      A4($Subs.getSubChoices,
      data.deletionCosts,
      data.subCosts,
      dag,
      subChoice.rest)) : _U.list([]);
      return A2($Basics._op["++"],
      A2($List.filterMap,
      A5(toWordChoice,
      data.wordCosts,
   ...
   var getSuccessors = F3(function (data,dag,state) {
      var word = $PricedValue.getValue(state.leftovers);
      var rest = A2($CompletionDict.startWith,
      word,
      data.wordCosts) ? A2($List.concatMap,
      A5(getWordChoices,data,dag,state.spellings,word,0.0),
      A4($Subs.getSubChoices,
      data.deletionCosts,
      data.subCosts,
      dag,
   ...
   var stateKey = function (state) {
      return {ctor: "_Tuple3"
             ,_0: state.rest.i
             ,_1: $CBool.cBool(state.rest.inSpace)
             ,_2: state.leftovers};
   };
   var deletionToState = function (deletion) {
      return _U.update(deletion,
      {state: {spellings: _U.list([])
              ,rest: deletion.state
              ,leftovers: _U.list([])}});
   };
   var getSeed = F2(function (deletionCosts,dag) {
      return A2($List.map,
      deletionToState,
      A3($Deletions.getDeletions,deletionCosts,dag,0));
   });
   var repronounce = F2(function (data,wordLists) {
      var dag = $DAG.fromPathLists(wordLists);
      var knapsacks = A3($Knapsack.getKnapsacks,
      stateKey,
      A2(getSuccessors,data,dag),
      A2(getSeed,data.deletionCosts,dag));
      return A2($Maybe.map,
      function (_p1) {
         return $List.reverse(function (_) {
            return _.spellings;
         }(function (_) {    return _.state;}(_p1)));
      },
      A2($Dict.get,
      {ctor: "_Tuple3"
      ,_0: $DAG.length(dag) - 1
      ,_1: $CBool.cTrue
      ,_2: $PricedValue.empty},
      knapsacks));
   });
   var State = F3(function (a,b,c) {
      return {spellings: a,rest: b,leftovers: c};
   });
   var CostData = F3(function (a,b,c) {
      return {deletionCosts: a,subCosts: b,wordCosts: c};
   });
   return _elm.Repronounce.values = {_op: _op
                                    ,CostData: CostData
                                    ,State: State
                                    ,repronounce: repronounce
                                    ,getSeed: getSeed
                                    ,deletionToState: deletionToState
                                    ,stateKey: stateKey
                                    ,getSuccessors: getSuccessors
                                    ,getWordChoices: getWordChoices
                                    ,toWordChoice: toWordChoice};
};
Elm.Respell = Elm.Respell || {};
Elm.Respell.make = function (_elm) {
   "use strict";
   _elm.Respell = _elm.Respell || {};
   if (_elm.Respell.values) return _elm.Respell.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Repronounce = Elm.Repronounce.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm),
   $SubCosts = Elm.SubCosts.make(_elm),
   $WordCosts = Elm.WordCosts.make(_elm);
   var _op = {};
   var Digit = {ctor: "Digit"};
   var Letter = {ctor: "Letter"};
   var classOfChar = function (c) {
      return $Char.isLower(c) ? $Maybe.Just(Letter) : $Char.isDigit(c) ? $Maybe.Just(Digit) : $Maybe.Nothing;
   };
   var startsWithClassOf = F2(function (c,s) {
      return A2($Maybe.withDefault,
      false,
      A3($Maybe.map2,
      ...
      $String.uncons(s),
      function (_p0) {
         return classOfChar($Basics.fst(_p0));
      })));
   });
   var getToken = function (s) {
      ...
      if (_p1.ctor === "Nothing") {
            ...
            return $Maybe.Just(function () {
               var subResult = A2(startsWithClassOf,
               _p4,
               _p3) ? getToken(_p3) : $Maybe.Nothing;
               var _p2 = subResult;
               if (_p2.ctor === "Nothing") {
                     return {ctor: "_Tuple2",_0: $String.fromChar(_p4),_1: _p3};
                  } else {
                     return {ctor: "_Tuple2"
                            ,_0: A2($String.cons,_p4,_p2._0._0)
                            ,_1: _p2._0._1};
                  }
            }());
         }
   };
   var getWordList = F3(function (pronouncer,subSpelling,text) {
      var _p5 = getToken(text);
      if (_p5.ctor === "Nothing") {
            return $Maybe.Nothing;
         } else {
            var _p7 = _p5._0._1;
            return $Maybe.Just(function () {
               var spelling = A2($Basics._op["++"],subSpelling,_p5._0._0);
               var subResult = A2($CompletionDict.startWith,
               spelling,
               pronouncer) ? A3(getWordList,
               pronouncer,
               spelling,
               _p7) : $Maybe.Nothing;
               return A2($Maybe.withDefault,
               ...
               _U.list([]),
               A2($CompletionDict.get,spelling,pronouncer))
               ,_1: _p7},
               function () {
                  var _p6 = subResult;
                  if (_p6.ctor === "Just" && _p6._0.ctor === "_Tuple2" && _p6._0._0.ctor === "[]")
                  {
                        return $Maybe.Nothing;
                     } else {
                        return subResult;
   ...
   var pronounce = F2(function (pronouncer,text) {
      pronounce: while (true) {
         var _p8 = A3(getWordList,pronouncer,"",text);
         if (_p8.ctor === "Nothing") {
               return _U.list([]);
            } else {
               if (_p8._0._0.ctor === "[]") {
                     var _v5 = pronouncer,_v6 = _p8._0._1;
                     pronouncer = _v5;
                     text = _v6;
                     continue pronounce;
                  } else {
                     return A2($List._op["::"],
                     _p8._0._0,
                     A2(pronounce,pronouncer,_p8._0._1));
                  }
            }
      }
   });
   var getCostData = function (data) {
      return {deletionCosts: data.deletionCosts
             ,subCosts: data.subCosts
             ,wordCosts: data.wordCosts};
   };
   var respell = F2(function (data,text) {
      return A2($String.join,
      " ",
      A2($Maybe.withDefault,
      _U.list([]),
      A2($Repronounce.repronounce,
      getCostData(data),
      A2(pronounce,data.pronouncer,$String.toLower(text)))));
   });
   var LoadedData = F4(function (a,b,c,d) {
      return {pronouncer: a
             ,deletionCosts: b
             ,subCosts: c
             ,wordCosts: d};
   });
   return _elm.Respell.values = {_op: _op
                                ...
                                ,Letter: Letter
                                ,Digit: Digit
                                ,startsWithClassOf: startsWithClassOf
                                ,classOfChar: classOfChar};
};
Elm.DataLoader = Elm.DataLoader || {};
Elm.DataLoader.make = function (_elm) {
   "use strict";
   _elm.DataLoader = _elm.DataLoader || {};
   if (_elm.DataLoader.values) return _elm.DataLoader.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $DeletionCosts = Elm.DeletionCosts.make(_elm),
   ...
   $WordCosts = Elm.WordCosts.make(_elm);
   var _op = {};
   var WordCostsLoaded = function (a) {
      return {ctor: "WordCostsLoaded",_0: a};
   };
   var SubCostsLoaded = function (a) {
      return {ctor: "SubCostsLoaded",_0: a};
   };
   var DeletionCostsLoaded = function (a) {
      return {ctor: "DeletionCostsLoaded",_0: a};
   };
   var httpErrorToString = function (err) {
      var _p0 = err;
      switch (_p0.ctor)
      {case "Timeout": return "connection timed out";
         case "NetworkError": return "network error";
         case "UnexpectedPayload": return "unexpected payload";
         default: return A2($Basics._op["++"],
           "bad response code ",
           $Basics.toString(_p0._0));}
   };
   var WParseError = function (a) {
      return {ctor: "WParseError",_0: a};
   };
   var WLoadError = function (a) {
      return {ctor: "WLoadError",_0: a};
   };
   var SParseError = function (a) {
      return {ctor: "SParseError",_0: a};
   };
   var SLoadError = function (a) {
      return {ctor: "SLoadError",_0: a};
   };
   var DParseError = function (a) {
      return {ctor: "DParseError",_0: a};
   };
   var DLoadError = function (a) {
      return {ctor: "DLoadError",_0: a};
   };
   var LoadingState = F3(function (a,b,c) {
      return {deletionCostsState: a
             ,subCostsState: b
             ,wordCostsState: c};
   });
   var NotLoaded = function (a) {
      return {ctor: "NotLoaded",_0: a};
   };
   var Loaded = function (a) {    return {ctor: "Loaded",_0: a};};
   var loadedCheck = function (s) {
      var _p1 = {ctor: "_Tuple3"
                ,_0: s.deletionCostsState
                ,_1: s.subCostsState
                ,_2: s.wordCostsState};
      if (_p1.ctor === "_Tuple3" && _p1._0.ctor === "Just" && _p1._0._0.ctor === "Ok" && _p1._1.ctor === "Just" && _p1._1._0.ctor === "Ok" && _p1._2.ctor === "Just" && _p1._2._0.ctor === "Ok" && _p1._2._0._0.ctor === "_Tuple2")
      {
            return Loaded({pronouncer: _p1._2._0._0._0
                          ,deletionCosts: _p1._0._0._0
                          ,subCosts: _p1._1._0._0
                          ,wordCosts: _p1._2._0._0._1});
         } else {
            return NotLoaded(s);
         }
   };
      ...
      return {ctor: "_Tuple2"
             ,_0: function () {
                ...
                if (_p2.ctor === "Loaded") {
                      ...
                      var _p7 = _p2._0;
                      return loadedCheck(function () {
                         var _p3 = action;
                         switch (_p3.ctor)
                         {case "DeletionCostsLoaded": return _U.update(_p7,
                              {deletionCostsState: $Maybe.Just(A2($Result.andThen,
                              A2($Result.formatError,DLoadError,_p3._0),
                              function (_p4) {
                                 return A2($Result.formatError,
                                 DParseError,
                                 $DeletionCosts.parse(_p4));
                              }))});
                            case "SubCostsLoaded": return _U.update(_p7,
                              {subCostsState: $Maybe.Just(A2($Result.andThen,
                              A2($Result.formatError,SLoadError,_p3._0),
                              function (_p5) {
                                 return A2($Result.formatError,
                                 SParseError,
                                 $SubCosts.parse(_p5));
                              }))});
                            default: return _U.update(_p7,
                              {wordCostsState: $Maybe.Just(A2($Result.andThen,
                              A2($Result.formatError,WLoadError,_p3._0),
                              function (_p6) {
                                 return A2($Result.formatError,
                                 WParseError,
                                 $WordCosts.parse(_p6));
   ...
   var wordCostsURL = "data/entropyAndPronounce.txt";
   var wordCostsErrorToString = function (err) {
      var _p8 = err;
      if (_p8.ctor === "WLoadError") {
            return A2($Basics._op["++"],
            "error loading ",
            A2($Basics._op["++"],
            wordCostsURL,
            A2($Basics._op["++"],": ",httpErrorToString(_p8._0))));
         } else {
            return A2($Basics._op["++"],
            "error parsing words: ",
            $WordCosts.parseErrorToString(_p8._0));
         }
   };
   var subCostsURL = "data/substitutions.txt";
   var subCostsErrorToString = function (err) {
      var _p9 = err;
      if (_p9.ctor === "SLoadError") {
            return A2($Basics._op["++"],
            "error loading ",
            A2($Basics._op["++"],
            subCostsURL,
            A2($Basics._op["++"],": ",httpErrorToString(_p9._0))));
         } else {
            return A2($Basics._op["++"],
            "error parsing substitutions: ",
            $SubCosts.parseErrorToString(_p9._0));
         }
   };
   var deletionCostsURL = "data/deletions.txt";
   var init = {ctor: "_Tuple2"
              ,_0: NotLoaded({deletionCostsState: $Maybe.Nothing
                             ,subCostsState: $Maybe.Nothing
                             ,wordCostsState: $Maybe.Nothing})
              ,_1: $Effects.batch(_U.list([$Effects.task(A2($Task.map,
                                          DeletionCostsLoaded,
   ...
   var deletionCostsErrorToString = function (err) {
      var _p10 = err;
      if (_p10.ctor === "DLoadError") {
            return A2($Basics._op["++"],
            "error loading ",
            A2($Basics._op["++"],
            deletionCostsURL,
            A2($Basics._op["++"],": ",httpErrorToString(_p10._0))));
         } else {
            return A2($Basics._op["++"],
            "error parsing deletions: ",
            $DeletionCosts.parseErrorToString(_p10._0));
         }
   };
   var view = function (model) {
      ...
      function () {
         ...
         if (_p11.ctor === "Loaded") {
               ...
               return A2($Basics._op["++"],
               function () {
                  var _p12 = _p15.deletionCostsState;
                  if (_p12.ctor === "Just" && _p12._0.ctor === "Err") {
                        return _U.list([A2($Html.div,
                        _U.list([]),
                        _U.list([$Html.text(deletionCostsErrorToString(_p12._0._0))]))]);
                     } else {
                        return _U.list([]);
                     }
               }(),
               A2($Basics._op["++"],
               function () {
                  var _p13 = _p15.subCostsState;
                  if (_p13.ctor === "Just" && _p13._0.ctor === "Err") {
                        return _U.list([A2($Html.div,
                        _U.list([]),
                        _U.list([$Html.text(subCostsErrorToString(_p13._0._0))]))]);
                     } else {
                        return _U.list([]);
                     }
               }(),
               function () {
                  var _p14 = _p15.wordCostsState;
                  if (_p14.ctor === "Just" && _p14._0.ctor === "Err") {
                        return _U.list([A2($Html.div,
                        _U.list([]),
                        _U.list([$Html.text(wordCostsErrorToString(_p14._0._0))]))]);
                     } else {
                        return _U.list([]);
                     }
               }()));
   ...
   return _elm.DataLoader.values = {_op: _op
                                   ,deletionCostsURL: deletionCostsURL
                                   ,subCostsURL: subCostsURL
                                   ,wordCostsURL: wordCostsURL
                                   ,Loaded: Loaded
                                   ,NotLoaded: NotLoaded
                                   ,LoadingState: LoadingState
                                   ,init: init
                                   ,DLoadError: DLoadError
                                   ,DParseError: DParseError
                                   ,deletionCostsErrorToString: deletionCostsErrorToString
                                   ,SLoadError: SLoadError
                                   ,SParseError: SParseError
                                   ,subCostsErrorToString: subCostsErrorToString
                                   ,WLoadError: WLoadError
                                   ,WParseError: WParseError
                                   ,wordCostsErrorToString: wordCostsErrorToString
                                   ,httpErrorToString: httpErrorToString
                                   ,DeletionCostsLoaded: DeletionCostsLoaded
                                   ,SubCostsLoaded: SubCostsLoaded
                                   ,WordCostsLoaded: WordCostsLoaded
                                   ,update: update
...
Elm.Main.make = function (_elm) {
   ...
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $DataLoader = Elm.DataLoader.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Effects = Elm.Effects.make(_elm),
   $Html = Elm.Html.make(_elm),
   ...
   $Task = Elm.Task.make(_elm);
   var _op = {};
   var DataLoaded = function (a) {
      return {ctor: "DataLoaded",_0: a};
   };
   var update = F2(function (action,model) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "DataLoaded": var subUpdate = A2($DataLoader.update,
           _p0._0,
           model.dataLoader);
           return {ctor: "_Tuple2"
                  ,_0: _U.update(model,{dataLoader: $Basics.fst(subUpdate)})
                  ,_1: A2($Effects.map,DataLoaded,$Basics.snd(subUpdate))};
         case "EditText": return {ctor: "_Tuple2"
                                 ,_0: _U.update(model,{userText: _p0._0})
                                 ,_1: $Effects.none};
         default: return {ctor: "_Tuple2"
                         ,_0: _U.update(model,
                         {genText: function () {
                            var _p1 = model.dataLoader;
                            if (_p1.ctor === "NotLoaded") {
                                  return "not loaded";
                               } else {
                                  return A2($Respell.respell,_p1._0,model.userText);
                               }
                         }()})
                         ,_1: $Effects.none};}
   });
   var RespellText = {ctor: "RespellText"};
   var EditText = function (a) {
   ...
   var view = F2(function (address,model) {
      ...
      _U.list([A2($Html.div,
              _U.list([]),
              _U.list([A2($Html.a,
              _U.list([$Html$Attributes.href("https://github.com/evanshort73/homophone/blob/master/LICENSE")]),
              _U.list([$Html.text("License")]))]))
              ,A2($Html.div,
              _U.list([]),
              ...
              _U.list([A3($Html$Events.on,
                      ...
                      function (x) {
                         return A2($Signal.message,address,EditText(x));
                      })
              ...
              _U.list([A2($Html$Events.onClick,address,RespellText)
                      ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2"
                                                       ,_0: "padding"
                                                       ,_1: "10px 20px 10px 20px"}]))]),
              _U.list([$Html.text("->")]))]))
              ,A2($Html.div,_U.list([]),_U.list([$Html.text(model.genText)]))
              ,A2($Html.div,
              _U.list([]),
              _U.list([$DataLoader.view(model.dataLoader)]))]));
   });
   var init = {ctor: "_Tuple2"
              ,_0: {dataLoader: $Basics.fst($DataLoader.init)
                   ,userText: ""
                   ,genText: ""}
              ,_1: A2($Effects.map,DataLoaded,$Basics.snd($DataLoader.init))};
   var Model = F3(function (a,b,c) {
      return {dataLoader: a,userText: b,genText: c};
   });
